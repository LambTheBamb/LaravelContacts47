<?php $__env->startSection('title', 'Osamas App | Public Page'); ?>
...
<head>
    ...
    <title>PublicDynasty</title>
</head>
<body>
   
<h1> Contact Me, Cuz Why not </h1>

   <div> 
        <a href =<?php echo e(route('contacts.index')); ?>> All Contacts </a>
        <a href=<?php echo e(route('contacts.create')); ?>> Add Contacts </a>
        <a href=<?php echo e(route('contacts.show',1)); ?>> Show Contact </a>
   </div>
...
-->
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/745253.cloudwaysapps.com/ndrmkayhux/public_html/bloggy/resources/views/welcome.blade.php ENDPATH**/ ?>